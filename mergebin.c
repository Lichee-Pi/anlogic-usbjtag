...
int main()
{
	FILE *fp1, *fp2, *fp3;
	int bsz, fsz;
	fp1 = fopen("bootloader.bin", "rb");
	fp2 = fopen("firmware.bin", "rb");
	fp3 = fopen("flash.bin", "wb+");
	...
	printf("firmware written to flash.bin, You can use STVP or stm32flash to flash it in your microcontroller!\n");
